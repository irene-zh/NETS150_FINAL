...
public class BFSTest {
        ...
        @Test
    public void testTimeoutGetPath() {
        System.out.println("---Test Distance of 6---");
        long startTime = System.currentTimeMillis();       
        
        PageNode start = new PageNode("https://en.wikipedia.org/wiki/Economic_history_of_the_United_States");
        PageNode end = new PageNode("https://en.wikipedia.org/wiki/Harvard_University");  
        
        List<String> result = BFS.getPath(start, end);
       
        assertNull(result);
       
        System.out.println("This function timed out with a time of: " +
